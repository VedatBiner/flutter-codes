...
Widget buildRichTextRule(
  ...
  TextStyle defaultStyle = TextStyle(
    ...
    color:
        Theme.of(context).brightness == Brightness.dark
            ? Colors
                .white // Dark mode için beyaz renk
  ...
  if (dashTextA != null) {
    ...
    children.add(TextSpan(text: dashTextA, style: boldStyle));
  ...
  if (dashTextB != null) {
    ...
    children.add(TextSpan(text: dashTextB, style: boldStyle));
  ...
  if (dashTextC != null) {
    ...
    children.add(TextSpan(text: dashTextC, style: boldStyle));
  ...
  if (dashTextD != null) {
    ...
    children.add(TextSpan(text: dashTextD, style: boldStyle));
    currentIndex = indexOfDashD + dashTextD.length;
  }

  if (dashTextE != null) {
    int indexOfDashE = text.indexOf(dashTextE, currentIndex);
    children.add(
      TextSpan(
        text: text.substring(currentIndex, indexOfDashE),
        style: defaultStyle,
      ),
    );
    children.add(TextSpan(text: dashTextE, style: boldStyle));
    currentIndex = indexOfDashE + dashTextE.length;
  }
  ...
  return RichText(text: TextSpan(style: defaultStyle, children: children));
}
