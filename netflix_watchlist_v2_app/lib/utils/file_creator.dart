...
//   aa.vb.netflix_watchlist_v2_app/app_flutter/netflix_watch_list_v2_backups
//
// AKIŞ:
//   1️⃣ CSV → JSON
...
Future<void> copyBackupsToDownloadAndCleanup() async {
  ...
  final tempBackupDir = Directory(join(docsDir.path, 'netflix_watch_list_v2_backups'));

  if (!await tempBackupDir.exists()) return;

  final downloadDir = Directory(
    '/storage/emulated/0/Download/netflix_watch_list_v2_app',
  );
